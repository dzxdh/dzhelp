...
public class UserRedisServiceVertxEBProxy implements UserRedisService {
  ...
  public UserRedisServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public UserRedisServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
